#' Unemployment numbers regarding every county in Germany from 2015 to 2020 with a focus on age.
#'
#' This dataset contains unemployment numbers from all German counties over the
#' years 2015 to 2020, with a sole focus on younger and older persons.
#'
#' @format A \code{tibble} with 9378 rows and five columns:
#' \describe{
...
#'       There are only three categories, and two of these are overlapping:
#'
#'       \itemize{
#'           \item{15_to_less_than_20_years}
#'           \item{15_to_less_than_25_years}
#'           \item{55_to_less_than_65_years}
#'       }
#'   }
