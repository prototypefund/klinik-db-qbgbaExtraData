...
#'
#' This dataset contains unemployment percentages of all employable people from
#' all German counties over the years 2015 to 2020, with a focus on foreigners,
#' gender amd younger persons.
#'
#' @format A \code{tibble} with 15,630 rows and five columns:
#' \describe{
...
#'       belongs to. There are total numbers and four other categories:
#'
#'       \itemize{
#'           \item{total}
#'           \item{male}
#'           \item{female}
#'           \item{foreigner}
#'           \item{15_to_less_than_25_years}
#'       }
#'   }
#'   \item{\code{percent}}{An numeric value with the percentage of unemployed people.}
#' }
#'
...
#'
"unemployedPercentagesCategories"
